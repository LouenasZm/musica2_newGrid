!==============================================================================
subroutine flux_euler_5pts_SA_transition_c3
!==============================================================================
...
!==============================================================================
  ...
  if (is_bc_wall(3,2)) then
    ...
    Kgamma(ndx_e_r:nfx_e_r,ndy_e_r:nfy_e_r,nz)=0.0_wp
    Kre_theta(ndx_e_r:nfx_e_r,ndy_e_r:nfy_e_r,nz)=0.0_wp
  endif
  ...
  if (is_bc_1pt(3,1)) then
     ...
     do j=ndy_e_r,nfy_e_r
        do i=ndx_e_r,nfx_e_r
           ...
           Kgamma(i,j,k) = (rhogamma_n(i,j,k+1)-rhogamma_n(i,j,k-1))*vc + Kgamma(i,j,k) 
           Kre_theta(i,j,k) = (rhore_theta_n(i,j,k+1)-rhore_theta_n(i,j,k-1))*vc + Kre_theta(i,j,k) 
        enddo
     enddo
  endif
     ...
     do j=ndy_e_r,nfy_e_r
        do i=ndx_e_r,nfx_e_r
            ...
            Kgamma(i,j,k) = (a5(1)*(rhogamma_n(i,j,k+1)-rhogamma_n(i,j,k-1)) &
                           +a5(2)*(rhogamma_n(i,j,k+2)-rhogamma_n(i,j,k-2)))*vc + Kgamma(i,j,k)
            Kre_theta(i,j,k) = (a5(1)*(rhore_theta_n(i,j,k+1)-rhore_theta_n(i,j,k-1)) &
                           +a5(2)*(rhore_theta_n(i,j,k+2)-rhore_theta_n(i,j,k-2)))*vc + Kre_theta(i,j,k)
        enddo
     enddo
  enddo
  ...
  do k=ndz_e_r,nfz_e_r
     do j=ndy_e_r,nfy_e_r
        do i=ndx_e_r,nfx_e_r
            ...
            Kgamma(i,j,k)=  Kgamma(i,j,k)*ijacob3_v(i,j,k)
            Kre_theta(i,j,k)=  Kre_theta(i,j,k)*ijacob3_v(i,j,k)
        enddo
     enddo
  enddo
  
end subroutine flux_euler_5pts_SA_transition_c3
