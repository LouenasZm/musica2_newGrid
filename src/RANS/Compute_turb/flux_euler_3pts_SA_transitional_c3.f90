!==============================================================================
subroutine flux_euler_3pts_SA_transition_c3
!==============================================================================
  ...
  do k=ndz_r,nfz_r
     do j=ndy_e_r,nfy_e_r
        do i=ndx_e_r,nfx_e_r
           ...
           Kgamma(i,j,k) = 0.5_wp*(rhogamma_n(i,j,k+1)-rhogamma_n(i,j,k-1))*vc + Kgamma(i,j,k)
           Kre_theta(i,j,k) = 0.5_wp*(rhore_theta_n(i,j,k+1)-rhore_theta_n(i,j,k-1))*vc + Kre_theta(i,j,k)
        enddo
     enddo
  enddo
...
end subroutine flux_euler_3pts_SA_transition_c3