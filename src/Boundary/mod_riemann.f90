...
!===========================================================================
  !> authors: CM
  !> date: 09/11/2022
  !> Subsonic Inlet and Outlet BC based on Riemann invariants
...
contains
  ...
  subroutine bc_inlet_riemann_pfg_imin
  !==============================================================================
  ...
  end subroutine bc_inlet_riemann_pfg_imin

  subroutine bc_inlet_riemann_pfg_imax
  !==============================================================================
    !> Inlet boundary condition at imin for PFG eos
    !> Set free stream static quantities
  !==============================================================================
  ...
  end subroutine bc_inlet_riemann_pfg_imax

  subroutine bc_inlet_riemann_pfg_jmin
  !==============================================================================
    !> Inlet boundary condition at imin for PFG eos
    !> Set free stream static quantities
  !==============================================================================
  ...
  end subroutine bc_inlet_riemann_pfg_jmin

  subroutine bc_inlet_riemann_pfg_jmax
  !==============================================================================
    !> Inlet boundary condition at imin for PFG eos
    !> Set free stream static quantities
  !==============================================================================
  ...
  end subroutine bc_inlet_riemann_pfg_jmax
 
 
!  ! PRS
!  ! ===
!
!  subroutine bc_inlet_riemann_prs_imin
!  !==============================================================================
...
!    enddo
!  
!  end subroutine bc_inlet_riemann_prs_imin
!  
!  subroutine bc_inlet_riemann_prs_imax
!  !==============================================================================
...
!    enddo
!  
!  end subroutine bc_inlet_riemann_prs_imax
!  
!  
!  subroutine bc_inlet_riemann_prs_jmin
!  !==============================================================================
...
!    enddo
!  
!  end subroutine bc_inlet_riemann_prs_jmin
!  
!  
!  subroutine bc_inlet_riemann_prs_jmax
!  !==============================================================================
...
!    enddo
!  
!  end subroutine bc_inlet_riemann_prs_jmax
  ...
  subroutine bc_outlet_riemann_pfg_imin
  !==============================================================================
  ...
  end subroutine bc_outlet_riemann_pfg_imin

  subroutine bc_outlet_riemann_pfg_imax
  !==============================================================================
  ...
  end subroutine bc_outlet_riemann_pfg_imax

  subroutine bc_outlet_riemann_pfg_jmin
  !==============================================================================
  ...
  end subroutine bc_outlet_riemann_pfg_jmin

  subroutine bc_outlet_riemann_pfg_jmax
  !==============================================================================
  ...
  end subroutine bc_outlet_riemann_pfg_jmax
