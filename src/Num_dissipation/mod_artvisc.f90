...
!================================================================================
  ...
  implicit none
  ! -----------------------------------------------------------------------------
  ! coefficients for artificial viscosity
  real(wp) :: d2(1),d4(2),d6(3),d8(4),d10(5)
  ! -----------------------------------------------------------------------------

contains

  !==============================================================================
  subroutine init_artvisc(dissip_coeff)
  !==============================================================================
...
!!$   xnu2= dissip_coeff/2.0_wp/10.
  ...
  end subroutine init_artvisc

  !==============================================================================
  subroutine artvisc_o9
  !==============================================================================
...
!!$                     +0.5_wp*abs(vc1)+c_(i-1,j,k)*g_eta(i-1,j)
                ...
                Krho(i,j,k) = (srp12*Drho(i,j,k) -srm12*Drho(i-1,j,k))
                Krhou(i,j,k)= (srp12*Drhou(i,j,k)-srm12*Drhou(i-1,j,k))
                Krhov(i,j,k)= (srp12*Drhov(i,j,k)-srm12*Drhov(i-1,j,k))
                Krhow(i,j,k)= (srp12*Drhow(i,j,k)-srm12*Drhow(i-1,j,k))
                Krhoe(i,j,k)= (srp12*Drhoe(i,j,k)-srm12*Drhoe(i-1,j,k))
       ...
       do k=1,nz
          do j=1,ny
             do i=ndx_d,nfx_d
                ...
                Krho(i,j,k) = (srp12*Drho(i,j,k) -srm12*Drho(i-1,j,k) )*idx(i)
                Krhou(i,j,k)= (srp12*Drhou(i,j,k)-srm12*Drhou(i-1,j,k))*idx(i)
                Krhov(i,j,k)= (srp12*Drhov(i,j,k)-srm12*Drhov(i-1,j,k))*idx(i)
                Krhow(i,j,k)= (srp12*Drhow(i,j,k)-srm12*Drhow(i-1,j,k))*idx(i)
                Krhoe(i,j,k)= (srp12*Drhoe(i,j,k)-srm12*Drhoe(i-1,j,k))*idx(i)
                ! store dissipation coefficient
                !uvar(i,j,k,1)=sr
             enddo
          enddo
    ...
    ! Artificial viscosity in j-direction [compute Drho at j+1/2]
    ! ===================================
...
!!$                   +0.5_wp*abs(vc1)+c_(i,j-1,k)*g_eta(i,j-1)
  ...
  end subroutine artvisc_o9

  !==============================================================================
  subroutine artvisc_o7
  !==============================================================================
  ...
  end subroutine artvisc_o7
  
  !==============================================================================
  subroutine artvisc_o5
  !==============================================================================
  ...
  end subroutine artvisc_o5
  
  !==============================================================================
  subroutine artvisc_o3
  !==============================================================================
  ...
  end subroutine artvisc_o3

end module mod_artvisc
