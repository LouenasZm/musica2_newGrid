...
contains
  ...
  !===============================================================================
  subroutine irs2_ngh_c_v1
  !===============================================================================
    !> 2nd-order Implicit Residual Smoothing (IRS2) - curvilinear version
  ...
  !===============================================================================
    ...
    ! work arrays
    real(wp), dimension(1:nx) :: temp_k
    ! ----------------------------------------------------------------------------

    !----------------------------------------
    ! Implicitation of ksi-direction 
    !----------------------------------------
    if (is_irs_i) then
       !  i3 : i;   i1 : k;   i2 : j
       ...
       do i2=i2min,i2max
          do i3=i3min,i3max
             n2_ksi(i3,i2)=(y_eta(i3,i2)**2+x_eta(i3,i2)**2)*ijacob_irs(i3,i2)**2
          enddo
       enddo
...
!!$          do i2=i2min,i2max
!!$             do i3=i3min+1,i3max
!!$                rspecmh=abs(vc_ksi(i3-1,i2,i1))+c_(i3-1,i2,i1)*sqrt(n2_ksi(i3-1,i2))
!!$                rspecph=abs(vc_ksi(i3  ,i2,i1))+c_(i3  ,i2,i1)*sqrt(n2_ksi(i3,i2))
!!$                r_spec2(i3,i2,i1)=(0.5*(rspecmh+rspecph))**2
!!$             enddo
!!$          enddo
!!$       enddo
       ...
       do i2=i2min,i2max
          do i3=i3min,i3max
             n2_eta(i3,i2)=(y_ksi(i3,i2)**2+x_ksi(i3,i2)**2)*ijacob_irs(i3,i2)**2
          enddo
       enddo
       ...
       do i1=i1min,i1max
          do i2=i2min,i2max
             do i3=i3min+1,i3max
                ! rspecmh=sqrt(vc_ksi(i3-1,i2,i1)**2)+sqrt(vc_eta(i3-1,i2,i1)**2)+c_(i3-1,i2,i1)*(sqrt(n2_ksi(i3-1,i2))+sqrt(n2_eta(i3-1,i2)))
                ! rspecph=sqrt(vc_ksi(i3,i2,i1)**2)  +sqrt(vc_eta(i3,i2,i1)**2)  +c_(i3,i2,i1)*(  sqrt(n2_ksi(i3,i2))  +sqrt(n2_eta(i3,i2)))
                !rspecmh=sqrt(vc_ksi(i3-1,i2,i1)**2+vc_eta(i3-1,i2,i1)**2)+c_(i3-1,i2,i1)*(sqrt(n2_ksi(i3-1,i2))+sqrt(n2_eta(i3-1,i2)))
                !rspecph=sqrt(vc_ksi(i3,i2,i1)**2  +vc_eta(i3,i2,i1)**2)  +c_(i3,i2,i1)*(  sqrt(n2_ksi(i3,i2))  +sqrt(n2_eta(i3,i2)))
                ! rspecmh=sqrt(vc_ksi(i3-1,i2,i1)**2)+sqrt(vc_eta(i3-1,i2,i1)**2)+c_(i3-1,i2,i1)*ijacob_irs(i3-1,i2)
                ! rspecph=sqrt(vc_ksi(i3,i2,i1)**2)  +sqrt(vc_eta(i3,i2,i1)**2)  +c_(i3,i2,i1)*ijacob_irs(i3,i2)
                 rspecmh=sqrt(vc_ksi(i3-1,i2,i1)**2+vc_eta(i3-1,i2,i1)**2)+c_(i3-1,i2,i1)*(sqrt(n2_ksi(i3-1,i2)+n2_eta(i3-1,i2)))
                 rspecph=sqrt(vc_ksi(i3,i2,i1)**2  +vc_eta(i3,i2,i1)**2)  +c_(i3,i2,i1)*(  sqrt(n2_ksi(i3,i2)  +n2_eta(i3,i2)))
    ...
    !----------------------------------------
    ! Implicitation of eta-direction
    !----------------------------------------
    if (is_irs_j) then
       !  i3 : j;   i1 : k;   i2 : i
       ...
       do i3=i3min,i3max
          do i2=i2min,i2max
             n2_eta(i2,i3)=(y_ksi(i2,i3)**2+x_ksi(i2,i3)**2)*ijacob_irs(i2,i3)**2
          enddo
       enddo
...
!!$          do i3=i3min+1,i3max
!!$             do i2=i2min,i2max
!!$                rspecmh=abs(vc_eta(i2,i3-1,i1))+c_(i2,i3-1,i1)*sqrt(n2_eta(i2,i3-1))
!!$                rspecph=abs(vc_eta(i2,i3  ,i1))+c_(i2,i3  ,i1)*sqrt(n2_eta(i2,i3))
!!$                r_spec2(i2,i3,i1)=(0.5*(rspecmh+rspecph))**2
!!$             enddo
!!$          enddo
!!$       enddo
       ...
       do i3=i3min,i3max
          do i2=i2min,i2max
             n2_ksi(i2,i3)=(y_eta(i2,i3)**2+x_eta(i2,i3)**2)*ijacob_irs(i2,i3)**2
          enddo
       enddo
       ...
       do i1=i1min,i1max
          do i3=i3min+1,i3max
             do i2=i2min,i2max
                ! rspecmh=sqrt(vc_eta(i2,i3-1,i1)**2)+sqrt(vc_ksi(i2,i3-1,i1)**2)+c_(i2,i3-1,i1)*(sqrt(n2_eta(i2,i3-1))+sqrt(n2_ksi(i2,i3-1)))
                ! rspecph=sqrt(vc_eta(i2,i3,i1)**2)  +sqrt(vc_ksi(i2,i3,i1)**2)  +c_(i2,i3,i1)*(  sqrt(n2_eta(i2,i3))+sqrt(n2_ksi(i2,i3)))
                !rspecmh=sqrt(vc_eta(i2,i3-1,i1)**2+vc_ksi(i2,i3-1,i1)**2)+c_(i2,i3-1,i1)*(sqrt(n2_eta(i2,i3-1))+sqrt(n2_ksi(i2,i3-1)))
                !rspecph=sqrt(vc_eta(i2,i3,i1)**2  +vc_ksi(i2,i3,i1)**2)  +c_(i2,i3,i1)*(  sqrt(n2_eta(i2,i3))  +sqrt(n2_ksi(i2,i3)))
                ! rspecmh=sqrt(vc_eta(i2,i3-1,i1)**2)+sqrt(vc_ksi(i2,i3-1,i1)**2)+c_(i2,i3-1,i1)*ijacob_irs(i2,i3-1)
                ! rspecph=sqrt(vc_eta(i2,i3,i1)**2)  +sqrt(vc_ksi(i2,i3,i1)**2)  +c_(i2,i3,i1)*ijacob_irs(i2,i3)
                rspecmh=sqrt(vc_eta(i2,i3-1,i1)**2+vc_ksi(i2,i3-1,i1)**2)+c_(i2,i3-1,i1)*(sqrt(n2_eta(i2,i3-1)+n2_ksi(i2,i3-1)))
                rspecph=sqrt(vc_eta(i2,i3,i1)**2  +vc_ksi(i2,i3,i1)**2)  +c_(i2,i3,i1)*(  sqrt(n2_eta(i2,i3)  +n2_ksi(i2,i3)))
       ...
       do i3=i3min+1,i3max
          do i1=i1min,i1max
             do i2=i2min,i2max
                ...
                r_spec2(i2,i1,i3)=(0.5*(rspecmh+rspecph)*deltat)**2
             enddo
          enddo
       enddo
  ...
  end subroutine irs2_ngh_c_v1

  !===============================================================================
  subroutine irs4_ngh_c_v1
  !===============================================================================
    !> 4th-order Implicit Residual Smoothing (IRS4) - curvilinear version
    !> Parallel inversion of tridiagonal matrix using ghost points
  !===============================================================================
    use mod_flow
    use mod_time
    ...
    real(wp), dimension(1:ny,ndx-ngh:nfx+ngh) :: RHS_i,RHSu_i,RHSv_i,RHSw_i,RHSe_i
    ! work arrays
    real(wp), dimension(1:ny) :: temp_i1,temp_i2
    ...
    ! work arrays
    real(wp), dimension(1:nx) :: temp_j1,temp_j2
    ...
    real(wp), dimension(1:nx,ndz-ngh:nfz+ngh) :: RHS_k,RHSu_k,RHSv_k,RHSw_k,RHSe_k
    ! work arrays
    real(wp), dimension(1:nx) :: temp_k1,temp_k2
    ! ----------------------------------------------------------------------------
...
!!$                rspecmh=abs(vc_ksi(i3-1,i2,i1))+c_(i3-1,i2,i1)*sqrt(n2_ksi(i3-1,i2))
!!$                rspecph=abs(vc_ksi(i3  ,i2,i1))+c_(i3  ,i2,i1)*sqrt(n2_ksi(i3  ,i2))
!!$                r_spec4(i3,i2,i1)=(0.5*(rspecmh+rspecph))**4
!!$             enddo
!!$          enddo
!!$       enddo
!!$
...
!!$          i3=i3min
!!$          do i2=i2min,i2max
!!$             coef=theta_irs1*dtodx(i3)*r_spec4(i3,i2,i1)**0.25
!!$             b_i(i2,i3)=0.0_wp
!!$             a_i(i2,i3)=-coef
!!$             d_i(i2,i3)=1.0_wp+coef
!!$          enddo
!!$
!!$          i3=i3max
!!$          do i2=i2min,i2max
...
!!$          i3=i3min+1
!!$          do i2=i2min,i2max
!!$             coef=-theta_irs2*dtodx(i3)**2
!!$             b_i(i2,i3)  =0.0_wp
!!$             a_i(i2,i3)  =coef*(r_spec4(i3,i2,i1))**0.5
!!$             c_i(i2,i3-1)=coef*(r_spec4(i3,i2,i1))**0.5
!!$             d_i(i2,i3)  =1.0_wp-(a_i(i2,i3)+c_i(i2,i3-1))
!!$          enddo
!!$
!!$          i3=i3max-1
...
!!$          do i3=i3min+2,i3max-2
!!$             do i2=i2min,i2max
!!$                coef=theta_irs4*dtodx(i3)**4
!!$                e_i(i2,i3-2)=coef*r_spec4(i3,i2,i1)
!!$                b_i(i2,i3)  =coef*r_spec4(i3,i2,i1)
!!$                c_i(i2,i3-1)=-3.0_wp*e_i(i2,i3-2)-b_i(i2,i3)
!!$                a_i(i2,i3)  =-3.0_wp*b_i(i2,i3)-e_i(i2,i3-2)
!!$                d_i(i2,i3)  =1.0_wp+3.0_wp*(e_i(i2,i3-2)+b_i(i2,i3))
!!$             enddo
!!$          enddo
          ...
          do i3=i3min+2,i3max-2
             do i2=i2min,i2max
                ...
                temp_i1(i2)=1.0_wp/(d_i(i2,i3)-b_i(i2,i3-2)*e_i(i2,i3-2) &
                                       -a_i(i2,i3-1)*temp_i2(i2))
                a_i(i2,i3)=(a_i(i2,i3)-b_i(i2,i3-1)*temp_i2(i2))*temp_i1(i2)
                b_i(i2,i3)=b_i(i2,i3)*temp_i1(i2)
                 RHS_i(i2,i3)=( RHS_i(i2,i3)- RHS_i(i2,i3-2)*e_i(i2,i3-2) &
                                    - RHS_i(i2,i3-1)*temp_i2(i2))*temp_i1(i2)
                RHSu_i(i2,i3)=(RHSu_i(i2,i3)-RHSu_i(i2,i3-2)*e_i(i2,i3-2) &
                                    -RHSu_i(i2,i3-1)*temp_i2(i2))*temp_i1(i2)
                RHSv_i(i2,i3)=(RHSv_i(i2,i3)-RHSv_i(i2,i3-2)*e_i(i2,i3-2) &
                                    -RHSv_i(i2,i3-1)*temp_i2(i2))*temp_i1(i2)
                RHSw_i(i2,i3)=(RHSw_i(i2,i3)-RHSw_i(i2,i3-2)*e_i(i2,i3-2) &
                                    -RHSw_i(i2,i3-1)*temp_i2(i2))*temp_i1(i2)
                RHSe_i(i2,i3)=(RHSe_i(i2,i3)-RHSe_i(i2,i3-2)*e_i(i2,i3-2) &
                                    -RHSe_i(i2,i3-1)*temp_i2(i2))*temp_i1(i2)
             enddo
          enddo
          ...
          do i3=i3max-2,i3min,-1
             do i2=i2min,i2max
                 RHS_i(i2,i3)= RHS_i(i2,i3)-a_i(i2,i3)* RHS_i(i2,i3+1) &
                                                       -b_i(i2,i3)* RHS_i(i2,i3+2)
                RHSu_i(i2,i3)=RHSu_i(i2,i3)-a_i(i2,i3)*RHSu_i(i2,i3+1) &
                                                       -b_i(i2,i3)*RHSu_i(i2,i3+2)
                RHSv_i(i2,i3)=RHSv_i(i2,i3)-a_i(i2,i3)*RHSv_i(i2,i3+1) &
                                                       -b_i(i2,i3)*RHSv_i(i2,i3+2)
                RHSw_i(i2,i3)=RHSw_i(i2,i3)-a_i(i2,i3)*RHSw_i(i2,i3+1) &
                                                       -b_i(i2,i3)*RHSw_i(i2,i3+2)
                RHSe_i(i2,i3)=RHSe_i(i2,i3)-a_i(i2,i3)*RHSe_i(i2,i3+1) &
                                                       -b_i(i2,i3)*RHSe_i(i2,i3+2)
             enddo
          enddo
...
!!$                rspecmh=abs(vc_eta(i2,i3-1,i1))+c_(i2,i3-1,i1)*sqrt(n2_eta(i2,i3-1))
!!$                rspecph=abs(vc_eta(i2,i3  ,i1))+c_(i2,i3  ,i1)*sqrt(n2_eta(i2,i3))
!!$                r_spec4(i2,i3,i1)=(0.5*(rspecmh+rspecph))**4
!!$             enddo
!!$          enddo
!!$       enddo
!!$
...
!!$          i3=i3min
!!$          do i2=i2min,i2max
!!$             coef=theta_irs1*dtody(i3)*r_spec4(i2,i3,i1)**0.25
!!$             b_j(i2,i3)=0.0_wp
!!$             a_j(i2,i3)=-coef
!!$             d_j(i2,i3)=1.0_wp+coef
!!$          enddo
!!$
!!$          i3=i3max
!!$          do i2=i2min,i2max
...
!!$          i3=i3min+1
!!$          do i2=i2min,i2max
!!$             coef=-theta_irs2*dtody(i3)**2
!!$             b_j(i2,i3)  =0.0_wp
!!$             a_j(i2,i3)  =coef*(r_spec4(i2,i3,i1))**0.5
!!$             c_j(i2,i3-1)=coef*(r_spec4(i2,i3,i1))**0.5
!!$             d_j(i2,i3)  =1.0_wp-(a_j(i2,i3)+c_j(i2,i3-1))
!!$          enddo
!!$
!!$          i3=i3max-1
...
!!$          do i3=i3min+2,i3max-2
!!$             do i2=i2min,i2max
!!$                coef=theta_irs4*dtody(i3)**4
!!$                e_j(i2,i3-2)=coef*r_spec4(i2,i3,i1)
!!$                b_j(i2,i3)  =coef*r_spec4(i2,i3,i1)
!!$                c_j(i2,i3-1)=-3.0_wp*e_j(i2,i3-2)-b_j(i2,i3)
!!$                a_j(i2,i3)  =-3.0_wp*b_j(i2,i3)-e_j(i2,i3-2)
!!$                d_j(i2,i3)  =1.0_wp+3.0_wp*(e_j(i2,i3-2)+b_j(i2,i3))
!!$             enddo
!!$          enddo
          ...
          do i3=i3min+2,i3max-2
             do i2=i2min,i2max
                ...
                a_j(i2,i3)=(a_j(i2,i3)-b_j(i2,i3-1)*temp_j2(i2))*temp_j1(i2)
                b_j(i2,i3)=b_j(i2,i3)*temp_j1(i2)
                 Krho(i2,i3,i1)=( Krho(i2,i3,i1)- Krho(i2,i3-2,i1)*e_j(i2,i3-2) &
                                      - Krho(i2,i3-1,i1)*temp_j2(i2))*temp_j1(i2)
                Krhou(i2,i3,i1)=(Krhou(i2,i3,i1)-Krhou(i2,i3-2,i1)*e_j(i2,i3-2) &
                                      -Krhou(i2,i3-1,i1)*temp_j2(i2))*temp_j1(i2)
                Krhov(i2,i3,i1)=(Krhov(i2,i3,i1)-Krhov(i2,i3-2,i1)*e_j(i2,i3-2) &
                                      -Krhov(i2,i3-1,i1)*temp_j2(i2))*temp_j1(i2)
                Krhow(i2,i3,i1)=(Krhow(i2,i3,i1)-Krhow(i2,i3-2,i1)*e_j(i2,i3-2) &
                                      -Krhow(i2,i3-1,i1)*temp_j2(i2))*temp_j1(i2)
                Krhoe(i2,i3,i1)=(Krhoe(i2,i3,i1)-Krhoe(i2,i3-2,i1)*e_j(i2,i3-2) &
                                      -Krhoe(i2,i3-1,i1)*temp_j2(i2))*temp_j1(i2)
             enddo
          enddo
          ...
          do i3=i3max-2,i3min,-1
             do i2=i2min,i2max
                 Krho(i2,i3,i1)= Krho(i2,i3,i1)-a_j(i2,i3)* Krho(i2,i3+1,i1) &
                                                           -b_j(i2,i3)* Krho(i2,i3+2,i1)
                Krhou(i2,i3,i1)=Krhou(i2,i3,i1)-a_j(i2,i3)*Krhou(i2,i3+1,i1) &
                                                           -b_j(i2,i3)*Krhou(i2,i3+2,i1)
                Krhov(i2,i3,i1)=Krhov(i2,i3,i1)-a_j(i2,i3)*Krhov(i2,i3+1,i1) &
                                                           -b_j(i2,i3)*Krhov(i2,i3+2,i1)
                Krhow(i2,i3,i1)=Krhow(i2,i3,i1)-a_j(i2,i3)*Krhow(i2,i3+1,i1) &
                                                           -b_j(i2,i3)*Krhow(i2,i3+2,i1)
                Krhoe(i2,i3,i1)=Krhoe(i2,i3,i1)-a_j(i2,i3)*Krhoe(i2,i3+1,i1) &
                                                           -b_j(i2,i3)*Krhoe(i2,i3+2,i1)
             enddo
          enddo
       enddo
       ...
       do i3=i3min+1,i3max
          do i1=i1min,i1max
             do i2=i2min,i2max
                rspecmh=(abs(ww(i2,i1,i3-1))+c_(i2,i1,i3-1))*idz(i3-1)
                rspecph=(abs(ww(i2,i1,i3  ))+c_(i2,i1,i3  ))*idz(i3)
                r_spec4(i2,i1,i3)=(0.5*(rspecmh+rspecph)*deltat)**4
             enddo
          enddo
       enddo
       ...
       do i1=i1min,i1max
          ...
          do i3=i3min+2,i3max-2
             do i2=i2min,i2max
                ...
                temp_k1(i2)=1.0_wp/(d_k(i2,i3)-b_k(i2,i3-2)*e_k(i2,i3-2) &
                                     -a_k(i2,i3-1)*temp_k2(i2))
                a_k(i2,i3)=(a_k(i2,i3)-b_k(i2,i3-1)*temp_k2(i2))*temp_k1(i2)
                b_k(i2,i3)=b_k(i2,i3)*temp_k1(i2)
                 RHS_k(i2,i3)=( RHS_k(i2,i3)- RHS_k(i2,i3-2)*e_k(i2,i3-2) &
                                  - RHS_k(i2,i3-1)*temp_k2(i2))*temp_k1(i2)
                RHSu_k(i2,i3)=(RHSu_k(i2,i3)-RHSu_k(i2,i3-2)*e_k(i2,i3-2) &
                                  -RHSu_k(i2,i3-1)*temp_k2(i2))*temp_k1(i2)
                RHSv_k(i2,i3)=(RHSv_k(i2,i3)-RHSv_k(i2,i3-2)*e_k(i2,i3-2) &
                                  -RHSv_k(i2,i3-1)*temp_k2(i2))*temp_k1(i2)
                RHSw_k(i2,i3)=(RHSw_k(i2,i3)-RHSw_k(i2,i3-2)*e_k(i2,i3-2) &
                                  -RHSw_k(i2,i3-1)*temp_k2(i2))*temp_k1(i2)
                RHSe_k(i2,i3)=(RHSe_k(i2,i3)-RHSe_k(i2,i3-2)*e_k(i2,i3-2) &
                                  -RHSe_k(i2,i3-1)*temp_k2(i2))*temp_k1(i2)
             enddo
          enddo
          ...
          do i3=i3max-2,i3min,-1
             do i2=i2min,i2max
                 RHS_k(i2,i3)= RHS_k(i2,i3)-a_k(i2,i3)* RHS_k(i2,i3+1) &
                                                   -b_k(i2,i3)* RHS_k(i2,i3+2)
                RHSu_k(i2,i3)=RHSu_k(i2,i3)-a_k(i2,i3)*RHSu_k(i2,i3+1) &
                                                   -b_k(i2,i3)*RHSu_k(i2,i3+2)
                RHSv_k(i2,i3)=RHSv_k(i2,i3)-a_k(i2,i3)*RHSv_k(i2,i3+1) &
                                                   -b_k(i2,i3)*RHSv_k(i2,i3+2)
                RHSw_k(i2,i3)=RHSw_k(i2,i3)-a_k(i2,i3)*RHSw_k(i2,i3+1) &
                                                   -b_k(i2,i3)*RHSw_k(i2,i3+2)
                RHSe_k(i2,i3)=RHSe_k(i2,i3)-a_k(i2,i3)*RHSe_k(i2,i3+1) &
                                                   -b_k(i2,i3)*RHSe_k(i2,i3+2)
             enddo
          enddo
  ...
  end subroutine irs4_ngh_c_v1
  
end module mod_irs_c_v1
