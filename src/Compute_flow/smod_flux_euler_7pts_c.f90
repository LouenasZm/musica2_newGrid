!=================================================================================
submodule (mod_flux_euler) smod_flux_euler_7pts_c
!=================================================================================
  !> author: XG
  !> date: January 2024
  !> 2.5D curvilinear version - compute Eulerian fluxes (inviscid part) with 7-pt stencil
  !> /!\ ATTENTION wedge routines not written yet
!=================================================================================
  ...
  !==============================================================================
   ...
   ! Computation of curvilinear fluxes along eta
    ...
    if (BC_edge(1,1,1)%sort==2) &
                                ! call flux_euler_w_imin_jmin_7pts_c
         call mpistop('flux_euler_w_imin_jmin_7pts_c not implemented yet !',0)
    if (BC_edge(1,1,2)%sort==2) &
                                ! call flux_euler_w_imin_jmax_7pts_c
         call mpistop('flux_euler_w_imin_jmax_7pts_c not implemented yet !',0)
    if (BC_edge(1,2,1)%sort==2) &
                                ! call flux_euler_w_imax_jmin_7pts_c
         call mpistop('flux_euler_w_imax_jmin_7pts_c not implemented yet !',0)
    if (BC_edge(1,2,2)%sort==2) &
                                ! call flux_euler_w_imax_jmax_7pts_c
         call mpistop('flux_euler_w_imax_jmax_7pts_c not implemented yet !',0)
...
end submodule smod_flux_euler_7pts_c
