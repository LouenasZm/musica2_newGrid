!=================================================================================
submodule (mod_flux_euler) smod_flux_euler_11pts_c
!=================================================================================
  !> author: XG
  !> date: January 2024
...
contains
  ...
  !==============================================================================
    ...
    if (BC_edge(1,1,1)%sort==2) &
         call flux_euler_w_imin_jmin_11pts_c
    if (BC_edge(1,1,2)%sort==2) &
         call flux_euler_w_imin_jmax_11pts_c
    if (BC_edge(1,2,1)%sort==2) &
         call flux_euler_w_imax_jmin_11pts_c
    if (BC_edge(1,2,2)%sort==2) &
         call flux_euler_w_imax_jmax_11pts_c
...
end submodule smod_flux_euler_11pts_c
