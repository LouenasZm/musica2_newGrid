!=================================================================================
submodule (mod_flux_euler) smod_flux_euler_11pts_c3
!=================================================================================
  !> author: XG
  !> date: January 2024
  !> Full 3D curvilinear version - compute Eulerian fluxes (inviscid part) with 11-pt stencil
!=================================================================================
       ...
       do j=ndy_e,nfy_e
          do i=ndx_e,nfx_e
             Krho(i,j,k)  = a11(1)* ( Frho(i,j,k+1)-Frho(i,j,k-1) ) &
                          ...
                          + a11(5)* ( Frho(i,j,k+5)-Frho(i,j,k-5) ) + Krho(i,j,k)
             ...
             Krhou(i,j,k) = a11(1)* ( Frhou(i,j,k+1)-Frhou(i,j,k-1) ) &
                          ...
                          + a11(5)* ( Frhou(i,j,k+5)-Frhou(i,j,k-5) ) + Krhou(i,j,k)
             ...
             Krhov(i,j,k) = a11(1)* ( Frhov(i,j,k+1)-Frhov(i,j,k-1) ) &
                          ...
                          + a11(5)* ( Frhov(i,j,k+5)-Frhov(i,j,k-5) ) + Krhov(i,j,k)
             ...
             Krhow(i,j,k) = a11(1)* ( Frhow(i,j,k+1)-Frhow(i,j,k-1) ) &
                          ...
                          + a11(5)* ( Frhow(i,j,k+5)-Frhow(i,j,k-5) ) + Krhow(i,j,k)
             ...
             Krhoe(i,j,k) = a11(1)* ( Frhoe(i,j,k+1)-Frhoe(i,j,k-1) ) &
                          ...
                          + a11(5)* ( Frhoe(i,j,k+5)-Frhoe(i,j,k-5) ) + Krhoe(i,j,k)
          enddo
       enddo
    enddo
...
end submodule smod_flux_euler_11pts_c3
